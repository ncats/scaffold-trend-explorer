                ...
                switch (scope.type) {
                    ...
                    case "search":
                        $templateRequest(baseurl + "assets/templates/substance-search.html").then(function (html) {
                            var tempUrl = baseurl + "assets/templates/elements/suggest-popup.html";
                            template = angular.element(html.replace("{{templateUrl}}", tempUrl));
                            element.append(template);
                            $compile(template)(scope);
                        });
                        if (attrs.definition) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                if (attrs.mark == "exclaim") {
                    template = angular.element('<span ng-click ="showInfo()"><i class="fa fa-exclamation-circle fa-md" aria-hidden="true" uib-tooltip="click for description"></i></span>');
                } else {
                    template = angular.element('<span ng-click ="showInfo()"><i class="fa fa-question-circle fa-md"  aria-hidden="true" uib-tooltip="click for description"></i></span>');
                }
                element.append(template);
                $compile(template)(scope);
                //if (attrs.info) {
